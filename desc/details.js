...
window.DETAILS = {
 ...
 "orders": {
  "1": {
   ...
   "exception": [
    "권한: 조리 시작/완료·픽업·예약 수락/거절 등 상태 변경은 <code>staff</code>도 가능하나, <b>환불(결제 취소) 및 주문 거절은 owner 전용</b>(SPEC §1.6, STATES §1.4). staff도 주문 내역은 <b>전체 기간 조회 가능</b>(사장님과 동일).",
 ...
 "membership": {
  "1": {
   ...
   "behavior": [
    ...
    "<b>권한</b>: 기본값 사장님 전용. <b>권한은 추후 메뉴·카테고리별로 자유롭게 설정</b>(직원 노출 여부를 메뉴 단위로 지정)하는 기능으로 관리 예정. 권한 없는 항목은 좌측 메뉴에 회색+자물쇠로 노출(클릭 시 403) — SPEC §1.6.2 원칙."
   ],
   "data": [
 ...
 "stamp": {
  "1": {
   ...
   "exception": [
    "<b>권한</b>: 기본값 사장님 전용. <b>권한은 추후 메뉴·카테고리별로 설정</b>(직원 노출 여부 지정)하는 기능으로 관리 예정. 권한 없는 항목은 좌측 메뉴 회색+자물쇠(클릭 시 403) — SPEC §1.6.2 원칙. 직접 URL 진입 시 403 모달 \"<b>사장님 권한이 필요해요. 가맹점주 본인 계정으로 로그인해 주세요</b>\"(§08-common 4.1).",
 ...
 "stl-list": {
  "1": {
   ...
   "exception": [
    "권한: <b>정산은 직원 비노출(사장님 전용)</b> — 좌측 메뉴 회색+자물쇠, 진입 시 403 모달. (권한은 추후 메뉴별 설정 기능으로 관리하되 정산은 기본 직원 비노출.)",
 ...
 "reviews": {
  "1": {
   ...
   "data": [
    ...
    "<b>권한</b>: 리뷰 조회는 직원도 가능, 답변 등록·기능 ON/OFF는 기본 사장님 전용 — <b>권한은 추후 메뉴별 설정 가능</b>(직원 허용 여부 지정).",
  ...
  "2": {
   ...
   "exception": [
    "OFF 상태에서도 토글은 항상 조작 가능해야 하며, 안내 패널의 \"손님 리뷰 받기\"를 강조(굵게 표시)해 재활성 경로를 명시한다.",
